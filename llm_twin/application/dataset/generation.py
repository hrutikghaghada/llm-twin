...
from llm_twin.domain.dataset import DatasetType, TrainTestSplit
from llm_twin.domain.prompt import GenerateDatasetSamplesPrompt, Prompt
...
"""
            ...
            for i, batch in enumerate(batches):
                try:
                    ...
                    for dataset_sample_batch in batched_dataset_samples:
                        flattened_dataset_samples.extend(dataset_sample_batch)
    ...
    def post_process_datasets(
        cls,
        datasets: dict[DataCategory, domain.dataset.InstructDataset | domain.dataset.PreferenceDataset],
        test_size: float,
    ) -> TrainTestSplit:
        pass
