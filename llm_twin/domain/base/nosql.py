...
class NoSQLBaseDocument(BaseModel, Generic[T], ABC):
    ...
    def from_mongo(cls: Type[T], data: dict) -> T:
        """Convert MongoDB document -> Python object."""
        if not data:
    ...
    def to_mongo(self: T, **kwargs) -> dict:
        """Convert Python object -> MongoDB document (reverse of from_mongo)"""
    ...
    def model_dump(self: T, **kwargs) -> dict:
        """Overrides Pydantic's model_dump to ensure all UUIDs are converted to strings."""
