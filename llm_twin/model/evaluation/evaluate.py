...
print(f"DATASET_HUGGINGFACE_WORKSPACE={DATASET_HUGGINGFACE_WORKSPACE}")  # noqa
print(f"MODEL_HUGGINGFACE_WORKSPACE={MODEL_HUGGINGFACE_WORKSPACE}")  # noqa
print(f"IS_DUMMY={IS_DUMMY}")  # noqa
print("=============================")  # noqa
...
model_ids = [
    check_if_huggingface_model_exists(
        f"{MODEL_HUGGINGFACE_WORKSPACE}/TwinLlama-3.1-8B", default_value="hrutikghaghada/TwinLlama-3.1-8B"
    ),
    check_if_huggingface_model_exists(
        f"{MODEL_HUGGINGFACE_WORKSPACE}/TwinLlama-3.1-8B-DPO", default_value="hrutikghaghada/TwinLlama-3.1-8B-DPO"
    ),
...
if __name__ == "__main__":
    ...
    for model_id in model_ids:
        dataset_name = check_if_huggingface_dataset_exists(
            f"{DATASET_HUGGINGFACE_WORKSPACE}/llmtwin", default_value="hrutikghaghada/llmtwin"
        )
